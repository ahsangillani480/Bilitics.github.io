...
<?php include 'include/header.php' ?>
	...
	<section class="banner-area" id="home">
		<img src='<?php echo $result['picSource']; ?>'  height ='307' width='307' alt="banner image" class="mt-7 ml-5 position-absolute banner-img w-30">
		<img src='<?php echo $result1['picSource']; ?>'  height ='307' width='307' alt="banner image" class="mt-7 ml-5 position-absolute banner-img w-30" style="margin-left:65% !important; margin-top:25% !important;">
				...
				<div class="carousel-inner">
					...
					<div class="carousel-item">
						...
						<p class="pb-3">The best angular admin template out there with awesome design, components, cohesive code and quick support. Many options
							to use and attention to every detail. </p>
					</div>
				</div>
	...
	<section class="blogs py-10" id="blog">
		<div class="container">
			...
			<div style="text-align:center">
				<a href="Blogs.php"  class="primary-btn">View All Blogs</a>
			</div>
				...
				<div class="card mb-4 box-shadow">
					...
					<div class="card-body">
						...
						<div class="d-flex justify-content-between align-items-center">
							<a href="#features" class="danger">Continue Reading</a>
