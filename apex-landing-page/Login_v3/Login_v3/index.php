...
if(isset($_POST['submit']))
{
	...
	if($total==1)
	{
		...
		?>
	                  ...
	                  <META HTTP-EQUIV = "Refresh" CONTENT="0; URL = http://localhost/apex-landing-page/Login_v3/Login_v3/adminPanelNew.php" >  <!--here 0 is for refreshing no of seonds-->
	...
	else
	{
		...
		?>
	                  ...
	                  <META HTTP-EQUIV = "Refresh" CONTENT="0; URL = http://localhost/apex-landing-page/Login_v3/Login_v3/index.php" >  <!--here 0 is for refreshing no of seonds-->
